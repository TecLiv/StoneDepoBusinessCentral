codeunit 50104 "Barcode 3 of 9"
{
    ...
    procedure MkBarcode("Barcode Text": Text[250]; var Pic: Record TempBlob; Extended: Boolean)
    var
        OStrm: OutStream;
        CH: Char;
        L: Integer;
    ...
    begin
        ...
        IF SpaceAlloc < (XPad + X) * Y THEN BEGIN
            // Allocate space.
            SpaceAlloc := (XPad + X) * Y;
            Pic.Blob.CREATEOUTSTREAM(OStrm);
