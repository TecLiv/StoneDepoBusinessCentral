report 50114 "Inventory Status-Sales1"
{
    // version DSJS
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './Inventory Status-Sales1.rdlc';
    ...
    dataset
    {
        ...
        dataitem(DataItem1000000000; Integer)
        {
            ...
            begin
                ...
                ItemLedgerEntry.SETRANGE(ItemLedgerEntry."Item No.", TempProcessOnlyforEMailReport.Code);
                ItemLedgerEntry.SETFILTER(ItemLedgerEntry."Posting Date", '%1..%2', 0D, (StartDate - 1));
            ...
            begin
                ...
                TempProcessOnlyforEMailReport.SETRANGE(TempProcessOnlyforEMailReport."Document Type", TempProcessOnlyforEMailReport."Document Type"::All);
