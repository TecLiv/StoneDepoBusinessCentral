report 50101 "Standard Sales - InvoiceNew"
{
    // version DSJS01,DSMS02

    DefaultLayout = RDLC;
    RDLCLayout = './Standard Sales - InvoiceNew.rdlc';
    WordLayout = './Standard Sales - InvoiceNew.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(CompanyBankBranchNo_Lbl; CompanyInfo."Bank Branch No.")
            {
            }
            ...
            column(CompanyIBAN_Lbl; CompanyInfo.IBAN)
            {
            }
            column(CompanySWIFT; CompanyInfo."SWIFT Code")
            {
            }
            column(CompanySWIFT_Lbl; CompanyInfo."SWIFT Code")
            {
            }
            ...
            column(DocumentTitle_Lbl; SalesInvoiceLbl + ' |  ' + "No.")
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(QuantityAddBase_Line; Line."Qty. To Ship (SLABS)")
                {
                }
                column(Thickness_Line; Line."Thickness (mm)")
                {
                }
            ...
            {
                UseTemporary = true;
                column(VATIdentifier_VATClauseLine; VATClauseLine."VAT Identifier")
                {
                }
                column(Code_VATClauseLine; VATClause.Code)
                {
                }
                column(Code_VATClauseLine_Lbl; VATClause.Code)
                {
                }
                ...
                column(VATAmount_VATClauseLine; VATClauseLine."VAT Amount")
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
                ...
                trigger OnAfterGetRecord()
                begin
                    IF VATClauseLine."VAT Clause Code" = '' THEN
                        CurrReport.SKIP;
                    IF NOT VATClause.GET(VATClauseLine."VAT Clause Code") THEN
                        CurrReport.SKIP;
